# QUEST Claude Development Pack — Start Here
...
4. `/quest-phase-03-social-graph`
5. `/quest-phase-04-passport-gamification`
6. `/quest-phase-05-media-proof`
7. `/quest-phase-06-ai-intelligence`
8. `/quest-phase-07-discovery-ranking`
9. `/quest-phase-08-location-map`
10. `/quest-phase-09-crews-community`
11. `/quest-phase-10-world-quest`
12. `/quest-phase-11-creators`
13. `/quest-phase-12-viral-growth`
14. `/quest-phase-13-brands-monetization`
15. `/quest-phase-14-trust-safety`
16. `/quest-phase-15-analytics-growth`
...
- Exact Phase 00–16 Claude workflows
- Target product/system architecture
- MVP definition
- Quality gates
- ADR template
- Progress/backlog templates
